...
class Sidebar : public wxPanel
{
    ...
    ScalableButton *  cfs_btn{nullptr};
    ...
    bool can_sync_creality_cfs() const;
    bool load_creality_cfs_list();
    void show_creality_cfs_slots();
...
public:
    ...
    void calib_flowrate(bool is_linear, int pass, InfillPattern pattern);
